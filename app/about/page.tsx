...
const milestones = [
  ...
  },
  {
    ...
    description: "Established partnerships with 15+ leading companies for mentorship and internship opportunities.",
    icon: Users,
  },
  {
    year: "2022",
    title: "National Recognition",
    description: 'Received "Best Entrepreneurship Cell" award from Maharashtra State Innovation Society.',
    icon: Award,
  },
  {
    year: "2023",
    title: "Alumni Success",
    description: "Our alumni founded 25+ successful startups with combined valuation exceeding ₹100 crores.",
    icon: TrendingUp,
  },
  {
    year: "2024",
    title: "Global Expansion",
    description: "Launched international collaboration programs with universities in Silicon Valley and Europe.",
    icon: Target,
  },
]
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground text-pretty">
              Since 2018, EDIC TCET has been at the forefront of entrepreneurship education, transforming innovative
              ideas into successful ventures and shaping the future of business.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mx-auto max-w-4xl">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-muted-foreground text-pretty">
                  The Entrepreneurship Development and Innovation Cell (EDIC) at Thakur College of Engineering and
                  Technology was established with a singular mission: to bridge the gap between academic learning and
                  real-world entrepreneurship.
                </p>
                <p className="mt-4 text-lg leading-8 text-muted-foreground text-pretty">
                  We believe that every student has the potential to be an innovator and entrepreneur. Through our
                  comprehensive programs, mentorship initiatives, and state-of-the-art facilities, we provide the
